...
void FRopeSimulationRope::FLODData::Add(FRopeSimulationSolver* Solver, FRopeSimulationRope* Rope, int32 InLODIndex)
{
	...
	TArray<TVector<int32, 3>> ConstraintsPairs;
	ConstraintsPairs.Reserve(NumParticles-1);
	for (int32 i = 0; i < NumParticles-1; ++i)
	{
		ConstraintsPairs.Add(
	...
	RopeConstraints.SetStretchShearConstraints(ConstraintsPairs,Rope->Property);
