...
// 	class  CosseratActiveView
// 	{
// 	public:
// 		CosseratActiveView(TPBDParticles<Scalar,3>& Particles,TCosseratEdges<Scalar,3>& Edges)
// 			: Particles(Particles),Edges(Edges)
// 		{}
//
...
//
// 	private:
// 		TPBDParticles<Scalar,3> Particles;
// 		TCosseratEdges<Scalar,3> Edges;
// 		TArray<int32> Ranges;
// 	};
//
