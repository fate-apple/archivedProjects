	...
	class PD_API TPDEvolution : public TArrayCollection
{
	...
	const TArray<TFunction<void(const TPBDParticles<T, d>&,const TCosseratEdges<T, d>&, const T,SparseMatrix&CRPosLhs ,SparseMatrix&CRQuatLhs,Vec&CRPosRhs,Vec&CRQuatRhs)>>& ConstraintRules() const { return MConstraintRules; }
	TArray<TFunction<void(const TPBDParticles<T, d>&,const TCosseratEdges<T, d>&, const T,SparseMatrix&CRPosLhs ,SparseMatrix&CRQuatLhs,Vec&CRPosRhs,Vec&CRQuatRhs)>>& ConstraintRules() { return MConstraintRules; }
	...
	TArray<TFunction<void(const TPBDParticles<T, d>&,const TCosseratEdges<T, d>&, const T,SparseMatrix&CRPosLhs ,SparseMatrix&CRQuatLhs,Vec&CRPosRhs,Vec&CRQuatRhs)>> MConstraintRules;
	TPBDActiveView<TArray<TFunction<void(const TPBDParticles<T, d>&,const TCosseratEdges<T, d>&, const T,SparseMatrix&CRPosLhs ,SparseMatrix&CRQuatLhs,Vec&CRPosRhs,Vec&CRQuatRhs)>>> MConstraintRulesActiveView;
