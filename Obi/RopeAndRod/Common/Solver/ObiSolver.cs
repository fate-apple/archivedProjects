...
namespace Obi
{
    ...
    public sealed class ObiSolver : MonoBehaviour
    {
        ...
        public CRProperty PDCRProperty;
        ...
        public Oni.ConstraintParameters PDStretchShearConstraintParameters = new Oni.ConstraintParameters(true, Oni.ConstraintParameters.EvaluationOrder.Sequential, 1);
        public Oni.ConstraintParameters PDBendTwistConstraintParameters = new Oni.ConstraintParameters(true, Oni.ConstraintParameters.EvaluationOrder.Sequential, 1);
        ...
        [NonSerialized] private ObiNativeFloatList m_Masses;
        ...
        [NonSerialized] private ObiNativeVector4List m_InertiaTensors;
...
#region Mass arrays
        ...
        public ObiNativeFloatList Masses
        {
            get
            {
                if (m_Masses == null)
                    m_Masses = new ObiNativeFloatList();
                return m_Masses;
            }
        }
        ...
        public ObiNativeVector4List InertiaTensors
        {
            get
            {
                if (m_InertiaTensors == null)
                    m_InertiaTensors = new ObiNativeVector4List();
                return m_InertiaTensors;
            }
        }
...
#region Fluid properties
        ...
        public void Initialize()
        {
            if (!initialized)
            {
                ...
                m_Constraints[(int)Oni.ConstraintType.PDStretchShear] = new ObiPDStretchShearConstraintsData();
                m_Constraints[(int)Oni.ConstraintType.PDBendTwist] = new ObiPDBendTwistConstraintsData();
        ...
        private void EnsureParticleArraysCapacity(int count)
        {
            ...
            if (count >= positions.count)
            {
                ...
                Masses.ResizeInitialized(count);
                ...
                InertiaTensors.ResizeInitialized(count);
        ...
        public Oni.ConstraintParameters GetConstraintParameters(Oni.ConstraintType constraintType)
        {
            switch (constraintType)
            {
                ...
                case Oni.ConstraintType.PDStretchShear: return PDStretchShearConstraintParameters;
                case Oni.ConstraintType.PDBendTwist: return PDBendTwistConstraintParameters;
