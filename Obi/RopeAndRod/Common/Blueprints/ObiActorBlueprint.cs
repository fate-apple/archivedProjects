...
namespace Obi
{
    ...
    public abstract class ObiActorBlueprint : ScriptableObject, IObiParticleCollection
    {
        ...
        [HideInInspector] public ObiPDStretchShearConstraintsData PDstretchShearConstraintsData = null;
        [HideInInspector] public ObiPDBendTwistConstraintsData PDbendTwistConstraintsData = null;
        ...
        public IEnumerable<IObiConstraints> GetConstraints()
        {
            ...
            if (PDstretchShearConstraintsData != null && PDstretchShearConstraintsData.GetBatchCount() > 0)
                yield return PDstretchShearConstraintsData;
        }
        ...
        public IObiConstraints GetConstraintsByType(Oni.ConstraintType type)
        {
            switch (type)
            {
                ...
                case Oni.ConstraintType.PDStretchShear: return PDstretchShearConstraintsData;
                case Oni.ConstraintType.PDBendTwist: return PDbendTwistConstraintsData;
                default: return null;
            }
        }
