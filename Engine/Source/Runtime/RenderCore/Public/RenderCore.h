...
//begin sjw modify
DECLARE_CYCLE_STAT_EXTERN(TEXT("Anisotropy pass drawing"), STAT_RenderToonOutlinePassDrawTime, STATGROUP_SceneRendering, RENDERCORE_API);
//end sjw modify
...
DECLARE_CYCLE_STAT_EXTERN(TEXT("Primitive Cull"), STAT_PrimitiveCull,STATGROUP_InitViews, RENDERCORE_API);
