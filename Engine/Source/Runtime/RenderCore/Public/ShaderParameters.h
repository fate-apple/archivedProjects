...
//FMaterialShader adds a SetParameters function which allows the C++ code of your shader to change the values of bound HLSL parameters.
//Parameter binding is accomplished through the FShaderParameter/FShaderResourceParameter classes and can be done in the Constructor of the shader,
