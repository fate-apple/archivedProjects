...
public:
	...
	//add dynamic mesh batch. init from view.DynamicMeshElements
	...
	// add static mesh batch. init from viewCommands[passtype] ( init from ComputeViewVisibility->ComputeAndMarkRelevanceForViewParallel)
...
private:
	...
	// init in FParallelMeshDrawCommandPass::DispatchPassSetup
