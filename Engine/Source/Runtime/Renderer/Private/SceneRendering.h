...
public:
	...
	//以下 map size 与 Scene->Primitives.Num() 相同
	...
	// init  in FMaterialRelevance.GetRelevance_Internal
	TArray<FPrimitiveViewRelevance,SceneRenderingAllocator> PrimitiveViewRelevanceMap;

	//以下 map size 与 Scene->StaticMeshes.GetMaxIndex() 相同
	...
	// set in GatherDynamicMeshElements
