...
struct FMaterialCachedExpressionData
{
	...
	{
		MaterialAttributesPropertyConnectedBitmask = bIsConnected ? MaterialAttributesPropertyConnectedBitmask | (1i64 << (uint32)Property) : MaterialAttributesPropertyConnectedBitmask & ~(1i64 << (uint32)Property);
	}
	...
	UPROPERTY()
	uint64 MaterialAttributesPropertyConnectedBitmask = 0;
