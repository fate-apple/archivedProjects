...
FViewUniformShaderParameters::FViewUniformShaderParameters()
{
	...
	//begin sjw modify
	PreIntegratedToonBRDF = GWhiteTexture->TextureRHI;
	PreIntegratedToonSkinBRDF = GWhiteTexture->TextureRHI;
	PreIntegratedToonRoughnessBRDF = GWhiteTexture->TextureRHI;
	PreIntegratedToonBRDFSampler = TStaticSamplerState<SF_Bilinear, AM_Clamp, AM_Clamp, AM_Clamp>::GetRHI();
	//end sjw modify
