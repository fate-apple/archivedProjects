...
//begin sjw modify
#define PIXEL_INSPECTOR_SHADINGMODELID_TOONSTANDARD	 13
#define PIXEL_INSPECTOR_SHADINGMODELID_TOONHAIR 14
#define PIXEL_INSPECTOR_SHADINGMODELID_TOONSKIN 15
