...
void UMaterialGraph::RebuildGraphInternal(const TMap<UMaterialExpression*, TArray<UMaterialExpression*>>& SubgraphExpressionMap, const TMap<UMaterialExpression*, TArray<UMaterialExpressionComment*>>& SubgraphCommentMap)
{
	...
	if (!MaterialFunction && !SubgraphExpression)
	{
		...
		//begin sjw modify
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularOffset, Material), MP_SpecularOffset, LOCTEXT("MP_SpecularOffset", "Selects which shading model should be used per pixel")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularRange, Material), MP_SpecularRange, LOCTEXT("MP_SpecularRange", "Selects which shading model should be used per pixel")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_ShadowColor, Material), MP_ShadowColor, LOCTEXT("MP_ShadowColor", "Selects which shading model should be used per pixel")));
